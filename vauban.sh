...
{
    local first_option all_short_options='rilufsknbcah'
    first_option="${1:0:1}"
...
print_help()
{
    ...
    printf 'Usage: %s [-r|--rootfs <arg>] [-i|--initramfs <arg>] [-l|--conffs <arg>] [-u|--upload <arg>] [-f|--iso <arg>] [-s|--source-image <arg>] [-k|--ssh-priv-key <arg>] [-n|--name <arg>] [-b|--branch <arg>] [-a|--ansible-host <arg>] [-h|--help] [<stages-1>] ... [<stages-n>] ...\n' "$0"
